    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                //Code Changed Start
                ShrdMaster shr = new ShrdMaster();
                var user = shr.GetUserByEmail(model.Email);
                if (user != null)
                {
                    System.Net.Mail.MailMessage Msg = new System.Net.Mail.MailMessage();
                    // Sender e-mail address.
                    Msg.From = new System.Net.Mail.MailAddress("testeac7@gmail.com");
                    // Recipient e-mail address.
                    Msg.To.Add(model.Email);
                    Msg.Subject = "Your Password Details";
                    Msg.Body = "Hi, <br/><br/>Please check your Login Detailss<br/><b>Username:</b> " + user.Username + "<br/><b>Password:</b> " + user.Password + "<br/><br/>";
                    Msg.IsBodyHtml = true;
                    // your remote SMTP server IP.
                    System.Net.Mail.SmtpClient smtp = new System.Net.Mail.SmtpClient();
                    smtp.Host = "smtp.gmail.com";
                    smtp.Port = 587;
                    smtp.Credentials = new System.Net.NetworkCredential("testeac7@gmail.com", "popup$$1234");
                    smtp.EnableSsl = true;
                    smtp.Send(Msg);
                    return View("ForgotPasswordConfirmation");
                    //Code Changed End
